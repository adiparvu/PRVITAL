            ...
            VStack(spacing: 22) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    Text("Private by design, private by default")
                        .font(.headline)
                        .foregroundStyle(Theme.textPrimary)
                    OnboardingPrinciple(symbol: "iphone", title: String(localized: "Stays on your device"), detail: String(localized: "Your journal is stored locally and encrypted at rest."))
                        .appearTransition(delay: 0.05)
                    OnboardingPrinciple(symbol: "icloud.slash", title: String(localized: "No cloud unless you ask"), detail: String(localized: "Sync uses only your own private iCloud — off until you enable it."))
                        .appearTransition(delay: 0.10)
                    OnboardingPrinciple(symbol: "dollarsign.circle", title: String(localized: "Never sold, never ads"), detail: String(localized: "Your medical data is never sold or used for advertising."))
                        .appearTransition(delay: 0.15)
                    OnboardingPrinciple(symbol: "brain", title: String(localized: "No training without consent"), detail: String(localized: "Nothing is used to train models unless you turn it on."))
