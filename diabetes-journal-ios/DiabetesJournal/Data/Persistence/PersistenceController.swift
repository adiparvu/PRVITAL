...
enum AppSchema {
    static let appGroupIdentifier = "group.com.diabetesjournal"
    static let cloudKitContainerIdentifier = "iCloud.com.diabetesjournal"
...
enum PersistenceController {
    ...
    private static func makeConfiguration(cloudSync: Bool) -> ModelConfiguration {
        ...
        if let url = FileManager.default
            ...
            .appending(path: "DiabetesJournal.store") {
